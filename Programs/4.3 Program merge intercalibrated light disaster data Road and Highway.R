...
data<-read.csv("Cubic cells with intercalibrated light and projects disbursement Roads and Highways.csv")
...
##write.csv(data, "grid cell data with intercalibrated light project and disaster Road and Highway.csv", row.names=FALSE)
