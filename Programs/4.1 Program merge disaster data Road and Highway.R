...
data<-read.csv("Cubic cells with light and projects disbursement Roads and Highways.csv")
...
##write.csv(data, "grid cell data with light project and disaster Road and Highway.csv", row.names=FALSE)
